    	...
    	<div class="border  ">
			...
			<div class="d-flex justify-content-center text-center">
				<form action="../controller/updUsuario.jsp" method="post">
					...
					<label for="pass" class="text-decoration-underline">contraseña actual:</label>
					...
					<label for="repPass" class="text-decoration-underline">reingrese contraseña :</label>
					<input type="password" name="repPass" id="repPass" value="<% out.print(pass); %>" onkeyup="compararPass()" class="form-control mb-3" placeholder="reingrese contraseña para comparar" required>
